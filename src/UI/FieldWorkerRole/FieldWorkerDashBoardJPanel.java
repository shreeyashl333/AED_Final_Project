...
import UI.NgoStaffRole.ViewRequestJPanel;
...
public class FieldWorkerDashBoardJPanel extends javax.swing.JPanel {
     ...
     */
    public FieldWorkerDashBoardJPanel(JPanel userProcessContainer, UserAccount account, PetShelterOrg organization, Enterprise enterprise, Environment business) {
        initComponents();
