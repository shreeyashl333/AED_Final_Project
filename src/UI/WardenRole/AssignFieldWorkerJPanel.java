...
public class AssignFieldWorkerJPanel extends javax.swing.JPanel {
    ...
    private PetShelterOrg petShelterOrganization = new PetShelterOrg();
     ...
     */
    public AssignFieldWorkerJPanel(JPanel userProcessContainer, UserAccount account, PetShelterOrg organization, Enterprise enterprise, Environment business, WorkRequest workQ) {
        initComponents();
