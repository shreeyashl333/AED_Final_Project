...
public class MedAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private MedicineOrg medOrganization;
    private Environment business;
    private String selection;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    public MedAdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, MedicineOrg medOrganization, Enterprise enterprise, Environment business) {
        initComponents();
