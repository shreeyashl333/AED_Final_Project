...
public class FoodAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private ArrayList<PetShelterOrg> psorg;
    private ArrayList<Org> org;
    private Enterprise enterprise;
    private UserAccount userAccount;
    private FoodOrg foodOrganization;
    private Environment business;
    private String selection;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    public FoodAdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, FoodOrg foodOrganization, Enterprise enterprise, Environment business) {
        initComponents();
        ...
        for(Org o: org){
            if(o instanceof PetShelterOrg){
                psorg.add((PetShelterOrg) o);
            }
        }
