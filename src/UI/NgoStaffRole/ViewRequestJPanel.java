...
import BusinessModel.POJO.Users;
...
public class ViewRequestJPanel extends javax.swing.JPanel {
    ...
    private NgoOfficeOrg ngoOfficeOrganization;
    private Environment business;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    /**
     * Creates new form ViewReportedAnimalsJPanel
     */
    public ViewRequestJPanel(JPanel userProcessContainer, UserAccount account, NgoOfficeOrg ngoOfficeOrganization, Enterprise enterprise, Environment business) {
        initComponents();
