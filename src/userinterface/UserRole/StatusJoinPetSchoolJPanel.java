 ...
 * @author chaitanya
 */
public class StatusJoinPetSchoolJPanel extends javax.swing.JPanel {

    /**
     * Creates new form StatusJoinPetSchoolJPanel
     */
    ...
    public StatusJoinPetSchoolJPanel(JPanel userProcessContainer, Users users, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(790, 502));
        setSize(new java.awt.Dimension(790, 502));
        ...
        add(refreshTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 90, -1, 40));
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ReportID", "Status", "Course Type", "User Comments", "Resolved Date"
            }
        ) {
        ...
        workRequestJTable.setSelectionBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(workRequestJTable);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 950, 210));

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 36)); // NOI18N
        jLabel1.setText("Status of Pet School Admission");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/images/trainschool_2_1500x1000.jpg"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -210, 1280, 1430));
